-- Public storefront bootstrap — forward-only proposal.
--
-- Purpose:
...
--
-- IMPORTANT: this file is code-first and MUST be reviewed/tested before remote
-- application. Do not replay historical/REMOTE_ONLY migrations around it.
